  ...
  return (
    <div className="min-h-screen bg-[#FFFCF0] text-[#095764] font-sans">
      ...
      <main className="max-w-3xl mx-auto py-16 px-4 bg-[#FFFCF0] text-[#095764]">
        <div className="p-0">
          <h1 className="text-4xl md:text-5xl font-bold font-poppins mb-6 text-left border-b-2 border-[#F4EBD0] pb-4 text-[#095764]">Privacy Policy</h1>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">1. Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">2. How We Use Your Data</h2>
            <ul className="list-disc list-inside space-y-1 text-base text-[#7A7A7A]">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">3. Data Sharing & Disclosure</h2>
            <ul className="list-disc list-inside space-y-1 text-base text-[#7A7A7A]">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">4. Data Security</h2>
            <ul className="list-disc list-inside space-y-1 text-base text-[#7A7A7A]">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">5. Your Rights</h2>
            <ul className="list-disc list-inside space-y-1 text-base text-[#7A7A7A]">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">6. Children’s Privacy</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">7. Updates to This Policy</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-poppins mb-2 mt-0 text-[#2F2F2F]">8. Contact Us</h2>
